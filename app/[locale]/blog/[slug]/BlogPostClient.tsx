...
import { ArrowLeft, Calendar, Clock, Share2, Twitter, Linkedin, Facebook, ArrowRight } from "lucide-react";
import Navigation from "@/components/sections/Navigation";
import Footer from "@/components/sections/Footer";
import { generatePlaceholderSVG } from "@/lib/utils";
import { BlogPost, getRelatedPosts } from "../posts";
...
export default function BlogPostClient({ locale, slug, post }: BlogPostClientProps) {
  ...
  const renderMarkdown = (text: string) => {
    let parsed = text.replace(/\*\*(.*?)\*\*/g, '<strong class="text-dark-900">$1</strong>');
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
              ...
              >
                ...
                <div className="flex flex-wrap gap-2 mt-12 pt-8 border-t border-dark-900/10">
                  {(isTr ? post.keywords : post.keywordsEn).slice(0, 8).map((tag) => (
              ...
              >
                ...
                <div className="glass-card rounded-2xl p-6">
                  ...
                  <p className="text-small text-dark-900/70">
                    {isTr 
                      ? "Celebix ekibi olarak dijital dünyadan en güncel bilgileri ve uzman görüşlerini sizinle paylaşıyoruz."
                      : "As the Celebix team, we share the most up-to-date information and expert opinions from the digital world with you."}
                  </p>
                </div>
