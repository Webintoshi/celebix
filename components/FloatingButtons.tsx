...
export default function FloatingButtons() {
  ...
  return (
    <div className="fixed left-0 top-1/2 -translate-y-1/2 z-50 flex flex-col gap-2 pl-4">
      {/* Instagram Button */}
      <a
        href={instagramUrl}
        target="_blank"
        rel="noopener noreferrer"
        className="group flex items-center gap-3 bg-white hover:bg-gradient-to-r hover:from-purple-500 hover:via-pink-500 hover:to-orange-400 text-dark-900 hover:text-white pl-2 pr-5 py-3 rounded-r-full shadow-lg hover:shadow-xl transition-all duration-300 border border-dark-900/10 hover:border-transparent"
        aria-label="Instagram"
      >
        <div className="w-10 h-10 rounded-full bg-gradient-to-br from-purple-500 via-pink-500 to-orange-400 flex items-center justify-center text-white shadow-md group-hover:scale-110 transition-transform">
          <Instagram size={20} />
        </div>
        <span className="text-sm font-medium whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity duration-300 -ml-1">
          Instagram
        </span>
      </a>
      ...
      <a
        ...
        target="_blank"
        rel="noopener noreferrer"
        className="group flex items-center gap-3 bg-white hover:bg-[#25D366] text-dark-900 hover:text-white pl-2 pr-5 py-3 rounded-r-full shadow-lg hover:shadow-xl transition-all duration-300 border border-dark-900/10 hover:border-transparent"
        aria-label="WhatsApp"
      >
